...
* [RF power amplifier overview](https://bl-mirrotron.github.io.com/#200-mhz-rf-power-amplifier)
* [Control system overview](https://bl-mirrotron.github.io.com/)
...
The RF power amplifier requires two timing channels from the [Timing system](https://bl-mirrotron.github.io.com/#timing-system).
* <ins>Channel 2</ins>  for the RF Power Amp pulse gate
* <ins>Channel 3</ins>  for the RF Power Amp sample and hold

The RF power amplifier takes the low level signal generated from the [RF source](https://bl-mirrotron.github.io.com/#rf-source). The amplifier has a 75dB directional coupler mounted  on its output and the forward and reflected RF signals are available on the front panel. These signals are fed into the [RF power monitor](https://bl-mirrotron.github.io.com/mirrotron-rfpower-scope-tray/).
